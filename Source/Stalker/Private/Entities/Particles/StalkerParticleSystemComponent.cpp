...
void UStalkerParticleSystemComponent::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void UStalkerParticleSystemComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
IParticleCustom* _BCL UStalkerParticleSystemComponent::dcast_ParticleCustom()
{
	return this;
}
